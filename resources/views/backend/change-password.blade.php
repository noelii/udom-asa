...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary"><i class="fas fa-user-lock"></i> &nbsp Change Password &nbsp<i class="fas fa-user-lock"></i></div>
                    ...
                    <form method="POST" action="{{ route('change') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                &nbsp<i  class="fas fa-key"></i>    Change Password  
                                </button>
                            </div>
                        </div>
                    </form>
